...
public class ACityNGI : MonoBehaviour
{
    ...
    [Header("NGI Settings")]
    [SerializeField] bool useNGISettings;

    public OrbitAPI orbitAPI;

    public string serverOrbitResponse;
    ...
    private void HandleServerResponse(string obj)
    {
        serverOrbitResponse = obj;
    }
